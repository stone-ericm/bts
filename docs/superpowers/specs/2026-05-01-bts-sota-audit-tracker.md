...
fresh-target live-forward logging command and launch commit SHA. The historical
artifact schema/comparison slice is `bts_candidate_ranked_slate_pair_v1`, using
...
full fresh-target verdict remain part of the live-forward slice.
